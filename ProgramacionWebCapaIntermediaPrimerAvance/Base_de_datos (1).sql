...
CREATE TABLE IF NOT EXISTS `proyecto_bdm`.`kardex` (
  ...
  `Fecha_inscripcion_curso_Kardex` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `proyecto_bdm`.`comentario` (
  ...
  `Fecha_creacion_Comentario` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
